...
if %jver% NEQ 210 GOTO JAVA_NOT_INSTALLED
...
:JAVA_NOT_INSTALLED
@ECHO Java 21 is not installed. Only Java 21 is supported
@ECHO Please go to https://adoptopenjdk.net/index.html and install Java 21. Then retry installation.
PAUSE
GOTO END
