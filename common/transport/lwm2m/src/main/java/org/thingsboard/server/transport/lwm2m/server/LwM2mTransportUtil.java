...
public class LwM2mTransportUtil {
    ...
    // Firmware
    public static final String FIRMWARE_UPDATE_COAP_RESOURCE = "firmwareUpdateCoapResource";
    ...
    // Software
    public static final String SOFTWARE_UPDATE_COAP_RESOURCE = "softwareUpdateCoapResource";
