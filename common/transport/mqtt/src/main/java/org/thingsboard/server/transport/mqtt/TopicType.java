...
public enum TopicType {
    ...
    V1_GATEWAY(MqttTopics.GATEWAY_ATTRIBUTES_RESPONSE_TOPIC, MqttTopics.GATEWAY_ATTRIBUTES_TOPIC, null, null),
    V2_GATEWAY(MqttTopics.GATEWAY_ATTRIBUTES_RESPONSE_TOPIC_V2, MqttTopics.GATEWAY_ATTRIBUTES_TOPIC, null, null);
