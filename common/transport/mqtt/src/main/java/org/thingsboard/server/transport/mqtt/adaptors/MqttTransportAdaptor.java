...
public interface MqttTransportAdaptor {
    ...
    Optional<MqttMessage> convertToPublish(MqttDeviceAwareSessionContext ctx, TransportProtos.ProvisionDeviceResponseMsg responseMsg) throws AdaptorException;
