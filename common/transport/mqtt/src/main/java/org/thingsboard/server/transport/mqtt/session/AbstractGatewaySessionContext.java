 ...
 */
@Slf4j
public abstract class AbstractGatewaySessionContext extends MqttDeviceAwareSessionContext implements SessionMsgListener {


    private final AbstractGatewaySessionHandler parent;
    private final TransportService transportService;

    public AbstractGatewaySessionContext(AbstractGatewaySessionHandler parent, TransportDeviceInfo deviceInfo,
