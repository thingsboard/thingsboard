...
public interface CoapTransportAdaptor {
    ...
    Response convertToPublish(boolean isConfirmable, TransportProtos.GetAttributeResponseMsg responseMsg, int contentFormat) throws AdaptorException;

    Response convertToPublish(boolean isConfirmable, TransportProtos.AttributeUpdateNotificationMsg notificationMsg, int contentFormat) throws AdaptorException;

    Response convertToPublish(boolean isConfirmable, TransportProtos.ToDeviceRpcRequestMsg rpcRequest, DynamicMessage.Builder rpcRequestDynamicMessageBuilder, int contentFormat) throws AdaptorException;

    Response convertToPublish(boolean isConfirmable, TransportProtos.ToServerRpcResponseMsg msg, int contentFormat) throws AdaptorException;
