...
public class TbJsonTypeReferenceRedisSerializer<K, V> implements TbRedisSerializer<K, V> {

    private final TypeReference<V> typeReference;

    public TbJsonTypeReferenceRedisSerializer(TypeReference<V> typeReference) {
