...
public class AlarmCalculatedFieldConfigurationTest {

    @Test
    void validateShouldThrowWhenTsRollingArgumentIsUsed() {
        var cfg = new AlarmCalculatedFieldConfiguration();
        ...
        assertThatThrownBy(cfg::validate)
                ...
                .hasMessage("Calculated field with type: '" + CalculatedFieldType.ALARM + "' doesn't support TS_ROLLING arguments.");
    }
