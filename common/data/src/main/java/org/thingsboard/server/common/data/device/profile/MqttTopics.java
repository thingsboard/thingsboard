...
public class MqttTopics {
    ...
    // v2 gateway topics
    public static final String BASE_GATEWAY_API_TOPIC_V2 = "v2/gateway";
    public static final String GATEWAY_ATTRIBUTES_REQUEST_TOPIC_V2 = BASE_GATEWAY_API_TOPIC_V2 + ATTRIBUTES_REQUEST;
    public static final String GATEWAY_ATTRIBUTES_RESPONSE_TOPIC_V2 = BASE_GATEWAY_API_TOPIC_V2 + ATTRIBUTES_RESPONSE;
