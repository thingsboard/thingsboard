 ...
 */
package org.thingsboard.server.common.data.telemetry.wrapper;

import lombok.Data;
import org.thingsboard.server.common.data.telemetry.cmd.v1.AttributesSubscriptionCmd;
import org.thingsboard.server.common.data.telemetry.cmd.v1.GetHistoryCmd;
import org.thingsboard.server.common.data.telemetry.cmd.v1.TimeseriesSubscriptionCmd;
import org.thingsboard.server.common.data.telemetry.cmd.v2.AlarmDataCmd;
import org.thingsboard.server.common.data.telemetry.cmd.v2.AlarmDataUnsubscribeCmd;
import org.thingsboard.server.common.data.telemetry.cmd.v2.EntityCountCmd;
import org.thingsboard.server.common.data.telemetry.cmd.v2.EntityCountUnsubscribeCmd;
import org.thingsboard.server.common.data.telemetry.cmd.v2.EntityDataCmd;
import org.thingsboard.server.common.data.telemetry.cmd.v2.EntityDataUnsubscribeCmd;
