...
public enum ActionType {
    ...
    DELETED_COMMENT,
    SMS_SENT,
    OTA_ATTRIBUTES_UPDATED(TbMsgType.OTA_ATTRIBUTES_UPDATED),
    OTA_ATTRIBUTES_DELETED(TbMsgType.OTA_ATTRIBUTES_DELETED),
    OTA_TIMESERIES_UPDATED(TbMsgType.OTA_TIMESERIES_UPDATED);
