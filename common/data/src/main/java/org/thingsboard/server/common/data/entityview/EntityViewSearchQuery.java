...
public class EntityViewSearchQuery {
    ...
    // TODO: 13.10.21
    @ApiModelProperty(position = 1, value = "Type of the relation between ... (e.g. 'Contains' or 'Manages').")
    private String relationType;
    @ApiModelProperty(position = 2, value = "Array of entity view types to filter the related entities (e.g. 'new-entity-view-type').")
