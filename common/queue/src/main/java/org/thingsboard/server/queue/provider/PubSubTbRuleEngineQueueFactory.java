...
import org.thingsboard.server.queue.settings.TbPubSubSubscriptionSettings;
...
public class PubSubTbRuleEngineQueueFactory implements TbRuleEngineQueueFactory {
    ...
    @Override
    public TbQueueConsumer<TbProtoQueueMsg<ToRuleEngineMsg>> createToRuleEngineMsgConsumer(Queue queue) {
