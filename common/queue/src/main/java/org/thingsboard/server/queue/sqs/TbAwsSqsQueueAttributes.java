...
public class TbAwsSqsQueueAttributes {
    ...
    @Value("${queue.aws-sqs.queue-properties.clickhouse-events:}")
    ...
    @Getter
    private Map<String, String> clickhouseEventsAttributes;
    ...
    private void init() {
        ...
        clickhouseEventsAttributes = getConfigs(clickhouseEventsProperties);
    }
