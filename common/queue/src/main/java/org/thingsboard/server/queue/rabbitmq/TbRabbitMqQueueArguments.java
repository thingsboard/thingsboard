...
public class TbRabbitMqQueueArguments {
    ...
    @Value("${queue.rabbitmq.queue-properties.clickhouse-events:}")
    ...
    @Getter
    private Map<String, Object> clickhouseEventsArgs;
    ...
    private void init() {
        ...
        clickhouseEventsArgs = getArgs(clickhouseEventsProperties);
    }
