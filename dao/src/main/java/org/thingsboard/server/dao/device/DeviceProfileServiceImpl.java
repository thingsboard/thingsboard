...
public class DeviceProfileServiceImpl extends AbstractCachedEntityService<DeviceProfileCacheKey, DeviceProfile, DeviceProfileEvictEvent> implements DeviceProfileService {
    ...
    public DeviceProfile saveDeviceProfile(DeviceProfile deviceProfile) {
        ...
        try {
            ...
            eventPublisher.publishEvent(SaveDaoEvent.builder().tenantId(savedDeviceProfile.getTenantId()).entityId(savedDeviceProfile.getId())
                    .actionType(oldDeviceProfile == null ? EdgeEventActionType.ADDED : EdgeEventActionType.UPDATED).build());
        } catch (Exception t) {
    ...
    private void removeDeviceProfile(TenantId tenantId, DeviceProfile deviceProfile) {
        ...
        try {
            ...
            eventPublisher.publishEvent(DeleteDaoEvent.builder().tenantId(tenantId).entityId(deviceProfileId).build());
        } catch (Exception t) {
