...
public class AggregationRepository {
    ...
    @Async
    public CompletableFuture<List<TimescaleTsKvEntity>> findAvg(UUID tenantId, UUID entityId, String entityKey, long timeBucket, long startTs, long endTs) {
    ...
    @Async
    public CompletableFuture<List<TimescaleTsKvEntity>> findMax(UUID tenantId, UUID entityId, String entityKey, long timeBucket, long startTs, long endTs) {
        @SuppressWarnings("unchecked")
    ...
    @Async
    public CompletableFuture<List<TimescaleTsKvEntity>> findMin(UUID tenantId, UUID entityId, String entityKey, long timeBucket, long startTs, long endTs) {
        @SuppressWarnings("unchecked")
    ...
    @Async
    public CompletableFuture<List<TimescaleTsKvEntity>> findSum(UUID tenantId, UUID entityId, String entityKey, long timeBucket, long startTs, long endTs) {
        @SuppressWarnings("unchecked")
    ...
    @Async
    public CompletableFuture<List<TimescaleTsKvEntity>> findCount(UUID tenantId, UUID entityId, String entityKey, long timeBucket, long startTs, long endTs) {
        @SuppressWarnings("unchecked")
        List<TimescaleTsKvEntity> resultList = getResultList(tenantId, entityId, entityKey, timeBucket, startTs, endTs, FIND_COUNT);
        return CompletableFuture.supplyAsync(() -> resultList);
    }

    private List getResultList(UUID tenantId, UUID entityId, String entityKey, long timeBucket, long startTs, long endTs, String query) {
