...
public class DefaultTbDeviceService extends AbstractTbEntityService implements TbDeviceService, TbClaimDeviceService {
    ...
    @Override
    public ListenableFuture<Void> delete(Device device, User user) throws ThingsboardException {
        TenantId tenantId = device.getTenantId();
    ...
    @Override
    public Device assignDeviceToTenant(Device device, Tenant newTenant, User user) throws ThingsboardException {
        TenantId tenantId = device.getTenantId();
