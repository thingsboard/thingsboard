...
public abstract class BaseApiUsageState {
    ...
    private final Map<ApiStatsKey, Map<String, Long>> lastGaugesByServiceId = new HashMap<>();
    private final Map<ApiStatsKey, Long> gaugesReportCycles = new HashMap<>();
    private static long gaugeReportInterval = TimeUnit.MINUTES.toMillis(5); // non-final for testing
    ...
    public StatsCalculationResult calculate(ApiStatsKey key, long value, String serviceId) {
    ...
    private Long calculateGauge(ApiStatsKey key, long value, String serviceId) {
    ...
    public long get(ApiStatsKey key) {
    ...
    public long getHourly(ApiStatsKey key) {
