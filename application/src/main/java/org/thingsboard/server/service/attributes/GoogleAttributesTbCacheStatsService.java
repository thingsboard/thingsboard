...
@Service
public class GoogleAttributesTbCacheStatsService implements TbCacheStatsService<Cache<AttributesKey, AttributeCacheEntry>> {
    ...
    private Boolean attributeCacheStatsEnabled;
