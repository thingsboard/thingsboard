...
public abstract class BaseEntityViewProcessor extends BaseEdgeProcessor {
    ...
    protected Pair<Boolean, Boolean> saveOrUpdateEntityView(TenantId tenantId, EntityViewId entityViewId, EntityViewUpdateMsg entityViewUpdateMsg, EdgeId edgeId, CustomerId customerId) {
        ...
        entityViewService.saveEntityView(entityView, edgeId);
