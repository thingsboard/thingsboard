 ...
 * version {@code 4.2.2.4} and execute its {@code data/upgrade/lts/4.2.2.4/schema_update.sql} (which adds the
...
public class V4_2_2_4Migration implements LtsMigration {
    ...
    public V4_2_2_4Migration(JdbcTemplate jdbcTemplate, PlatformTransactionManager transactionManager) {
