...
public class DefaultTbClusterService implements TbClusterService {
    ...
    public void pushMsgToRuleEngine(TenantId tenantId, EntityId entityId, TbMsg tbMsg, boolean useQueueFromTbMsg, TbQueueCallback callback) {
        pushMsgToRuleEngine(tenantId, entityId, tbMsg, useQueueFromTbMsg, Collections.emptySet(), callback);
    }
    ...
    public void pushMsgToRuleEngine(TenantId tenantId, EntityId entityId, TbMsg tbMsg, Set<String> relations, TbQueueCallback callback) {
        pushMsgToRuleEngine(tenantId, entityId, tbMsg, true, relations, callback);
    }

    private void pushMsgToRuleEngine(TenantId tenantId, EntityId entityId, TbMsg tbMsg, boolean useQueueFromTbMsg, Set<String> relations, TbQueueCallback callback) {
