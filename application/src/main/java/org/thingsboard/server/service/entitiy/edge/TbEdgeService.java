...
public interface TbEdgeService {
    Edge save(Edge edge, RuleChain edgeTemplateRootRuleChain) throws ThingsboardException;

    Edge save(Edge edge, RuleChain edgeTemplateRootRuleChain, User user) throws ThingsboardException;
    ...
    Edge setEdgeRootRuleChain(Edge edge, RuleChainId ruleChainId, User user) throws ThingsboardException;
}
