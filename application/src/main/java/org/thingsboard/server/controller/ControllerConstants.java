...
public class ControllerConstants {
  ...
  protected static final String DEVICE_WITH_DEVICE_CREDENTIALS_PARAM_MQTT_BASIC_DESCRIPTION_MARKDOWN =
   ...
   protected static final String DEVICE_PROFILE_ALARM_CONDITION_DURATION_EXAMPLE = MARKDOWN_CODE_BLOCK_START +
    ...
    protected static final String ATTRIBUTES_KEYS_DESCRIPTION = "List of attributes keys. For example, 'active,inactivityAlarmTime'.";
    ...
    protected static final String TELEMETRY_KEYS_BASE_DESCRIPTION = "List of telemetry keys.";
