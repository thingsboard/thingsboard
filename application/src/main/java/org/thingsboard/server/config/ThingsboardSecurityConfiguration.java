...
public class ThingsboardSecurityConfiguration {
    ...
    public static final String DEVICE_BASED_LOGIN_ENTRY_POINT = "/api/device/registerDevice";
    ...
    protected JwtTokenAuthenticationProcessingFilter buildJwtTokenAuthenticationProcessingFilter() throws Exception {
        ...
        pathsToSkip.addAll(Arrays.asList(WS_ENTRY_POINT, TOKEN_REFRESH_ENTRY_POINT, FORM_BASED_LOGIN_ENTRY_POINT,
                ...
                DEVICE_CONNECTIVITY_CERTIFICATE_DOWNLOAD_ENTRY_POINT, DEVICE_BASED_LOGIN_ENTRY_POINT));
        ...
        http.headers(headers -> headers
                ...
                .authorizeHttpRequests(config -> config
                        ...
                        .requestMatchers(
                                ...
                                WS_ENTRY_POINT, DEVICE_BASED_LOGIN_ENTRY_POINT).permitAll() // Protected WebSocket API End-points
