(function (root, factory) {
	...
	L.TileLayer.Provider = L.TileLayer.extend({
		initialize: function (arg, options) {
			...
			if (!providers[providerName]) {
				throw 'No such provider  2222 (' + providerName + ')';
			}
	...
	L.TileLayer.Provider.providers = {
		...
		OpenStreetMapLocal: {
			url: 'http://192.168.15.100:8400/styles/osm-bright/{z}/{x}/{y}.png',
			options: {
				maxZoom: 19,
				attribution:
			...
			variants: {
				Bright: {},
				Klokantech: {
					url: 'http://192.168.15.100:8400/styles/klokantech-basic/{z}/{x}/{y}.png',
					options: {
						maxZoom: 20
					}
				},
				DarkMatter: {
					url: 'http://192.168.15.100:8400/styles/dark-matter/{z}/{x}/{y}.png',
					options: {
						maxZoom: 20
					}
				},
				Positron: {
					url: 'http://192.168.15.100:8400/styles/positron/{z}/{x}/{y}.png',
					options: {
						maxZoom: 20
					}
				}
