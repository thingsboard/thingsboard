...
-- ADD END SESSION ENDPOINT TO OAUTH2 CLIENT START

ALTER TABLE oauth2_client ADD COLUMN IF NOT EXISTS end_session_endpoint varchar(255);

-- ADD END SESSION ENDPOINT TO OAUTH2 CLIENT END