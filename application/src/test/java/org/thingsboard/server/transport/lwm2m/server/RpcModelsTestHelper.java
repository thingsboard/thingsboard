...
public class RpcModelsTestHelper {
    ...
    public List<ObjectModel> createObjectModels() {
        ...
        LwM2MTestObjectModelWithResource objectModelWithResourceRWSingle = new LwM2MTestObjectModelWithResource(RW, "RWS");
        ...
        LwM2MTestObjectModelWithResource objectModelWithResourceRWMulti = new LwM2MTestObjectModelWithResource(RW, "RWM");
        ...
        LwM2MTestObjectModelWithResource objectModelWithResourceRSingle = new LwM2MTestObjectModelWithResource(R, "RS");
        ObjectModel objectModelRSingle = objectModelWithResourceRSingle.getObjectModel(TEST_OBJECT_SINGLE_WITH_RESOURCE_R_ID, nameRSingle,
                objectVersion1_0, false);
        LwM2MTestObjectModelWithResource objectModelWithResourceRMulti = new LwM2MTestObjectModelWithResource(R, "RM");
