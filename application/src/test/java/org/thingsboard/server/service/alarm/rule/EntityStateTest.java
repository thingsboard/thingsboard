...
//        EntityState deviceState = createDeviceState(deviceId, alarmConfig);
//
...
//
//
//    private EntityState createDeviceState(DeviceId deviceId, AlarmRuleConfiguration... alarmConfigs) {
...
//        return new EntityState(ctx, new TbDeviceProfileNodeConfiguration(),
