...
/**
 * Drives {@link V4_2_2_4Migration#applyAfterCommit()} against a real Postgres instance with a batch size far
...
public class V4_2_2_4MigrationIntegrationTest extends AbstractControllerTest {

    @Autowired
    private JdbcTemplate jdbcTemplate;
    @Autowired
    private V4_2_2_4Migration migration;
