...
public class DefaultTbClusterServiceTest {
    ...
    public void testPushMsgToRuleEngineWithTenantIdIsNullUuidAndEntityIsTenantUseQueueFromMsgIsTrue() {
        ...
        verify(ruleEngineProducerService).sendToRuleEngine(tbREQueueProducer, tenantId, requestMsg, Collections.emptySet(), callback);
    }
    ...
    public void testPushMsgToRuleEngineUseQueueFromMsgIsFalse() {
        ...
        verify(ruleEngineProducerService).sendToRuleEngine(eq(tbREQueueProducer), eq(tenantId), actualMsg.capture(), eq(Collections.emptySet()), eq(callback));
