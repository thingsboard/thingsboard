...
public abstract class BaseAlarmControllerTest extends AbstractControllerTest {
    ...
    public void testCreateAlarmViaCustomer() throws Exception {
        ...
        Mockito.verify(tbClusterService, times(5)).pushMsgToRuleEngine((TenantId) Mockito.any(),
                Mockito.any(), Mockito.any(), Mockito.any());
        Mockito.verify(tbClusterService, times(5)).sendNotificationMsgToEdgeService(Mockito.any(),
                Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any());
        Mockito.verify(auditLogService, times(5)).logEntityAction(Mockito.any(), Mockito.any(),
    ...
    public void testUpdateAlarmViaCustomer() throws Exception {
        ...
        Mockito.verify(tbClusterService, times(6)).pushMsgToRuleEngine((TenantId) Mockito.any(),
                Mockito.any(), Mockito.any(), Mockito.any());
        Mockito.verify(tbClusterService, times(6)).sendNotificationMsgToEdgeService(Mockito.any(),
                Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any());
        Mockito.verify(auditLogService, times(6)).logEntityAction(Mockito.any(), Mockito.any(),
                Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any());
    ...
    public void testDeleteAlarmViaDifferentTenant() throws Exception {
        ...
        Mockito.verify(tbClusterService, times(6)).pushMsgToRuleEngine((TenantId) Mockito.any(),
                Mockito.any(), Mockito.any(), Mockito.any());
        Mockito.verify(tbClusterService, times(7)).sendNotificationMsgToEdgeService(Mockito.any(),
                Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any());
        Mockito.verify(auditLogService, times(6)).logEntityAction(Mockito.any(), Mockito.any(),
                Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any());
