...
public class OldTbGetTenantAttributeNodeTest extends OldTbAbstractAttributeNodeTest {
    User user = new User();
    ...
    public void failedChainUsedIfTenantIdFromCtxCannotBeFound() {
        when(ctxMock.getTenantId()).thenReturn(null);
    ...
    public void customerAttributeAddedInData() {
        ...
        when(attributesServiceMock.find(any(), eq(tenantId), eq(SERVER_SCOPE), anyCollection()))
