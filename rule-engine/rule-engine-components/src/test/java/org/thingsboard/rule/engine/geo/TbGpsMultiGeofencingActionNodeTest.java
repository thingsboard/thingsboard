...
public class TbGpsMultiGeofencingActionNodeTest {
    ...
    public void setUp() throws TbNodeException {
        ...
        configuration.setGeofenceStateAttributeKey("geofenceState");
        ...
        when(attributesService.find(any(), any(), any(), eq(configuration.getPerimeterAttributeKey()))).thenReturn(Futures.immediateFuture(Optional.of(perimeterAttribute)));

        when(attributesService.find(any(), any(), any(), eq(configuration.getGeofenceStateAttributeKey()))).thenReturn(Futures.immediateFuture(Optional.empty()));
    ...
    public void testInsideEvent() throws Exception {
        ...
        when(attributesService.find(any(), any(), any(), eq(nodeConfiguration.getGeofenceStateAttributeKey()))).thenReturn(Futures.immediateFuture(Optional.of(attributeKvEntry)));
