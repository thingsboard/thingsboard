...
@RuleNode(
        ...
        relationTypes = {"Post attributes", "Post telemetry", "RPC Request from Device", "RPC Request to Device", "Activity Event", "Inactivity Event",
                ...
                "Entity Unassigned", "Attributes Updated", "Attributes Deleted", "Alarm Acknowledged", "Alarm Cleared", "Provision Success", "Provision Failure", "Other"},
...
public class TbMsgTypeSwitchNode implements TbNode {
    ...
    public void onMsg(TbContext ctx, TbMsg msg) throws TbNodeException {
        ...
        } else if (msg.getType().equals(DataConstants.PROVISION_SUCCESS)) {
            relationType = "Provision Success";
        } else if (msg.getType().equals(DataConstants.PROVISION_FAILURE)) {
            relationType = "Provision Failure";
        } else {
            relationType = "Other";
        }
