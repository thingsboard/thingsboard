...
@RuleNode(type = ComponentType.ACTION,
        ...
        nodeDetails = "Administrator should set the custom table name without prefix: <b>cs_tb_</b>. <br>" +
                ...
                "Output connections: <code>Failure</code> - if specified message field does not exist or it is not a JSON Object or JSON Primitive, otherwise <code>Success</code>.",
