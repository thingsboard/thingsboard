...
public class TbMsgDeleteTimeseriesNodeConfiguration implements NodeConfiguration<TbMsgDeleteTimeseriesNodeConfiguration> {
    ...
    private String startTsTimeUnit;
    private String endTsTimeUnit;

    private boolean useMetadataIntervalPatterns;

    private String startTsIntervalPattern;
    private String endTsIntervalPattern;
    ...
    public TbMsgDeleteTimeseriesNodeConfiguration defaultConfiguration() {
        ...
        configuration.setEndTs(1);
        configuration.setStartTsIntervalPattern("");
        configuration.setEndTsIntervalPattern("");
        configuration.setDeleteAllDataForKeys(false);
        configuration.setRewriteLatestIfDeleted(false);
