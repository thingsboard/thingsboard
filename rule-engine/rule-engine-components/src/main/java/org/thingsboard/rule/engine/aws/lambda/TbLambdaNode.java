...
@RuleNode(
        ...
        nodeDescription = "Fetches data and pushes it to the AWS Lambda",
        nodeDetails = "Acceleration data generated by our vibration sensors needs to be converted to velocity and/or converted to the frequency domain.",
...
public class TbLambdaNode extends TbAbstractExternalNode {
    ...
    private Map<String, String> processInputKeys(TbMsg msg) {
        ...
        this.config.getInputKeys().forEach((funcKey, msgKey) -> {
            ...
            mappings.put(patternProcessedFuncKey, jsonNode.get(patternProcessedMsgKey).asText());
        });
        return mappings;
    }
