 ...
 */
@Data
public class TbDeleteTimeseriesNodeConfiguration implements NodeConfiguration<TbDeleteTimeseriesNodeConfiguration> {
    ...
    @Override
    public TbDeleteTimeseriesNodeConfiguration defaultConfiguration() {
        TbDeleteTimeseriesNodeConfiguration configuration = new TbDeleteTimeseriesNodeConfiguration();
        configuration.setLatestTsKeyNames(Collections.emptyList());
        configuration.setDeleteAllDataForKeys(false);
        configuration.setStartIntervalTimeUnit(TimeUnit.HOURS.name());
        configuration.setStartInterval(24);
