...
@Component({
  selector: 'tb-security-config-observe-attr-resource-lwm2m',
  templateUrl: './security-config-observe-attr-resource.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SecurityConfigObserveAttrResourceComponent),
      multi: true
    }
  ]
})
export class SecurityConfigObserveAttrResourceComponent extends PageComponent implements OnInit, ControlValueAccessor {
  ...
  constructor(protected store: Store<AppState>,
              ...
              public dialogRef: MatDialogRef<SecurityConfigObserveAttrResourceComponent, object>,
