...
export class GeneralSettingsComponent extends PageComponent implements HasConfirmForm, OnDestroy {
  ...
  availableGatewayVersions = ['latest'];
  ...
  private buildGatewaySettingsForm() {
  ...
  saveGatewaySettings(): void {
    this.gatewaySettings.jsonValue = {
      ...this.gatewaySettings.jsonValue,
      ...this.gatewaySettingsForm.getRawValue()
    };
  ...
  discardGatewaySettings(): void {
    this.gatewaySettingsForm.reset(this.gatewaySettings.jsonValue);
  }
  ...
  private processGatewaySettings(gatewaySettings: AdminSettings<GatewaySettings>): void {
    if (gatewaySettings.jsonValue?.availableVersions && gatewaySettings.jsonValue.availableVersions?.length) {
      this.availableGatewayVersions = gatewaySettings.jsonValue.availableVersions;
    }
    delete gatewaySettings.jsonValue.availableVersions;
  ...
  confirmForm(): FormGroup {
    ...
    if (this.gatewaySettingsForm.dirty) {
      return this.gatewaySettingsForm;
    }
  }
}
