...
export enum MessageType {
  ...
  ENTITY_RELATION_UPDATED = 'ENTITY_RELATION_UPDATED',
  ENTITY_RELATION_DELETED = 'ENTITY_RELATION_DELETED',
...
export const messageTypeNames = new Map<MessageType, string>(
  [
    ...
    [MessageType.ENTITY_RELATION_UPDATED, 'Entity Relation Updated'],
    [MessageType.ENTITY_RELATION_DELETED, 'Entity Relation Deleted'],
